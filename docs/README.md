...
- docs\Theory.md - a summary of the referenced article, contains a theoretical introduction to the problem of reinforcement learning in real option models.
- docs\notebooks\ - contains the algorithms from the article, implemented in ipynb format
- docs\img\ - contains the plots generated by the algorithms, for a quick review of the results.
